    ...
    <div className="flex min-h-screen w-full bg-djkn-50">
      ...
      <div className="flex-1 p-6 overflow-auto">
        <DashboardHeader
          ...
          subtitle="Tambah, edit, dan hapus pengumuman"
        />
          ...
          <CardContent className="pt-6">
            <div className="text-center space-y-4 py-12">
              ...
              <p className="text-djkn-600 max-w-md mx-auto">
                Halaman kelola pengumuman dengan fitur CRUD lengkap sedang dalam pengembangan.
                Untuk saat ini, Anda dapat menambah dan menghapus pengumuman melalui Overview Dashboard.
              </p>
            </div>
          </CardContent>
        </Card>
